...
(filtered_frame['DATA'] <= final_date) &
(filtered_frame['REFERENCIA'] == 'FARELO DE TRIGO - MG') &
(filtered_frame['DATA'] != '') ]
...
if filtered_frame_farelomg.empty == False:
    ...
    a13.markdown(f"<h6 style='text-align: left; color: blue;'>FARELO DE TRIGO - MINAS GERAIS</h6>", unsafe_allow_html=True)
...
(filtered_frame['DATA'] <= final_date) &
(filtered_frame['REFERENCIA'] == 'FARELO DE TRIGO - RJ') &
(filtered_frame['DATA'] != '') ]
...
if filtered_frame_farelorj.empty == False:
    ...
    a15.markdown(f"<h6 style='text-align: left; color: blue'>FARELO DE TRIGO - RIO DE JANEIRO</h6>", unsafe_allow_html=True)
